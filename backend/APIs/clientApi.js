...
clientApp.put('/client/:clientId', expressAsyncHandler(async (req, res) => {
...
clientApp.delete('/client/:clientId', expressAsyncHandler(async (req, res) =>
    {
